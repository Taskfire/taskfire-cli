...
async function handler(args) {
  ...
  const promises = files.map(async file => {
    (0, _output2.default)(`Uploading ${file}`);
  ...
  _output2.default.success('Deployment complete');
